...
**Reference implementation:** The `guardrails` plugin (`claude plugin install possiblaw-guardrails@possiblaw-plugins`) demonstrates this pattern with production-ready hooks for destructive command blocking, sensitive file protection, and auto-formatting. Use it as a starting point or install it directly.
